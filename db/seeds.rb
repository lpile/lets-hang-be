...
UserEvent.create!(user: user4, event: event1)
UserEvent.create!(user: user5, event: event1)
UserEvent.create!(user: user1, event: event2)
UserEvent.create!(user: user1, event: event3)
UserEvent.create!(user: user3, event: event3)
UserEvent.create!(user: user5, event: event3)
UserEvent.create!(user: user2, event: event4)
UserEvent.create!(user: user3, event: event4)
UserEvent.create!(user: user4, event: event4)
UserEvent.create!(user: user5, event: event4)
UserEvent.create!(user: user6, event: event4)
